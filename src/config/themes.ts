...
const spiceKitchen: ThemePreset = {
  name: "spice-kitchen",
  label: "Spice Kitchen",
  light: {
    background: "#faf6f0",
    ...
    success: "#4d8c5c",
    successLight: "#eef7f0",
    overlay: "rgba(44, 34, 24, 0.40)",
    cardShadow: "0 1px 3px rgba(44, 34, 24, 0.05), 0 4px 12px rgba(44, 34, 24, 0.04)",
    cardShadowHover: "0 2px 8px rgba(44, 34, 24, 0.07), 0 8px 24px rgba(44, 34, 24, 0.06)",
    searchShadow: "0 1px 2px rgba(44, 34, 24, 0.05)",
    navShadow: "0 -1px 12px rgba(44, 34, 24, 0.05)",
    primaryShadow: "0 2px 8px rgba(192, 98, 58, 0.25)",
  },
  dark: {
    background: "#151110",
    foreground: "#ece5db",
    ...
    searchShadow: "0 1px 2px rgba(0, 0, 0, 0.12)",
    navShadow: "0 -1px 12px rgba(0, 0, 0, 0.25)",
    primaryShadow: "0 2px 8px rgba(224, 122, 79, 0.25)",
  },
};

export const THEME_PRESETS: ThemePreset[] = [warmMauve, feederGreen, spiceKitchen];
